...
from dbbv.utils.query_history import load_history, save_history, MAX_HISTORY_ITEMS, MAX_RESULT_ROWS
    ...
    if request.method == 'POST':
        ...
        if action == 'run' and query:
            ...
            if len(paired_queries) > MAX_HISTORY_ITEMS:
                flash('MAX_HISTORY_ITEMS exceeded, deleted the last query from your history', 'warning')
